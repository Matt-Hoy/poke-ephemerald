...
$(OBJEVENTGFXDIR)/mega_stones/Venusaurite.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/mega_stones/Blastoisinite.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/mega_stones/CharizarditeX.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
