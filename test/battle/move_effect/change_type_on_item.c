...
SINGLE_BATTLE_TEST("Techno Blast changes type depending on the drive the user holds")
{
    ...
    PARAMETRIZE { species = SPECIES_TORKOAL; item = ITEM_DOUSE_DRIVE; }
    PARAMETRIZE { species = SPECIES_LUMINEON; item = ITEM_SHOCK_DRIVE; }
    PARAMETRIZE { species = SPECIES_SUNFLORA; item = ITEM_BURN_DRIVE; }
