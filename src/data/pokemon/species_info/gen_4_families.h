...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_STAMINA, ABILITY_NONE, ABILITY_SHELL_ARMOR },
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_DEFIANT, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_SNIPER, ABILITY_BATTLE_ARMOR, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_DRY_SKIN, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTEAN, ABILITY_NONE, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
