...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_PIXILATE, ABILITY_NONE, ABILITY_LIQUID_VOICE },
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_KEEN_EYE, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STAMINA, ABILITY_OWN_TEMPO, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, ABILITY_SIMPLE, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_PINK,
