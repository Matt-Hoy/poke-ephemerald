...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_NONE, ABILITY_CHLOROPHYLL },
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_MULTISCALE, ABILITY_NONE, ABILITY_SOLAR_POWER },
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_INNER_FOCUS, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_CLEAR_BODY, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INNER_FOCUS, ABILITY_MARVEL_SCALE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_AERILATE, ABILITY_INNER_FOCUS, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_BROWN,
