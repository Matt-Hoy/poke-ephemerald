...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_NONE, ABILITY_FLASH_FIRE},
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_SAND_RUSH },
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPETITIVE, ABILITY_NONE, ABILITY_SWARM },
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_SNIPER, ABILITY_EARLY_BIRD, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_ANALYTIC, ABILITY_KEEN_EYE },
    #else
