...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_AUDINO] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_HEALER, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_MOXIE, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOTHITA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_COMPETITIVE, ABILITY_FRISK },
    #else
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_NONE, ABILITY_FRISK },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_KLINK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_STURDY, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Klink"),
        .cryId = CRY_KLINK,
    ...
    [SPECIES_AXEW] =
    {
        ...
        .abilities = { ABILITY_DEFIANT, ABILITY_MOLD_BREAKER, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Axew"),
        .cryId = CRY_AXEW,
